    ...
    >
      ...
      <h2 style={{ paddingTop: "20px" }}>
        <center>
          <ReactTyped
            className="fw-bolder"
            strings={["Share your workout progress to the world !"]}
            typeSpeed={100}
            backSpeed={50}
            loop
          />
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-3">
            <label className="form-label">
              <b>Workout Metrics</b> (workout-parameter)
            </label>
            <textarea
              className="form-control"
              placeholder="MarathonPace Run - 12KM"
              value={description}
              onChange={(e) => setDescription(e.target.value)}
              required
            />
            {!validateWorkoutMetrics(description) && (
              <small className="text-danger">
                Please enter the workout metrics in the format
                Workout-Parameter.
              </small>
            )}
          </div>
          ...
          <div className="mb-3">
            ...
            {!validateWorkoutMetrics(description) && (
              <small className="text-danger">
                Enter Something you want to achieve in your workout checklist in
                near future.
              </small>
            )}
          </div>
