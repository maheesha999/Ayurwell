...
const styles = {
  ...
  actions: {
    ...
    gap: '0.6rem',
    marginBottom: '1rem',
    marginLeft: '24rem', // Adjusted position for actions
    fontWeight: 'bold',
  },
  replylink: {
    color: '#330D0F',
  ...
  mReplyBox: {
    ...
    display: 'flex',
    flexDirection: 'column',
    marginLeft: '4rem', // Adjusted position for reply box
    boxShadow: '0px 7px 8px rgba(0, 0, 0, 0.3)',
  },
  mchatMessage: {
    marginBottom: '1rem',
  ...
  mReplyMessage: {
    ...
    fontSize: '18px',
    overflowWrap: 'break-word',
    textAlign: 'left', // Ensure manager replies are aligned to the left
  },
};
