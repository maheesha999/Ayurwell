...
const GastrocardiacPage = () => {
  ...
  useEffect(() => {
    setLoading(true);
    axios
    .get(`http://localhost:5555/doctors?category=${category || "Gastrocardiac"}`) // Adjusted API endpoint for ENT doctors
      .then((response) => {
...
export default GastrocardiacPage;
