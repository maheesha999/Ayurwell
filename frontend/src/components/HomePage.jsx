        ...
        <div className="bg-gray-100">
            ...
            <div className="relative w-11/12 mx-auto h-96 md:h-[480px] bg-cover bg-center overflow-hidden my-16 transition-transform hover:scale-105"
             ...
             <div style={styles.pageContainer}>
                ...
                <p style={styles.sectionDescription}>
                Simply browse through our extensive list of trusted Ayurvedic doctors and <br/> find the right specialist near you.</p>
        ...
        {[ 
           ...
           <div className="relative w-11/12 mx-auto h-96 md:h-[480px] bg-cover bg-center overflow-hidden my-16 transition-transform hover:scale-105" 
            ...
            <div style={styles.pageContainer}>
                ...
                <p style={styles.sectionDescription}>
                Explore our wide range of high-quality herbal products,and support your health,<br/> all sourced from trusted ingredients.</p>
